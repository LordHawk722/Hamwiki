...
const orderedPageIds = collectLeafPageIds(preKnowledgeCatalog, []);
const orderedPageIdSet = new Set(orderedPageIds);
const titleById = collectLeafTitles(preKnowledgeCatalog, new Map());
...
export const preKnowledgePages = [...orderedPages, ...uncatalogedPages];